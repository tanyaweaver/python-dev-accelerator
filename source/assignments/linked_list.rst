...
Run the tests to show that it fails, then implement the code needed to make it pass.
Be thorough in your testing.
Ensure that you cover failure modes and possible edge-cases.
The tests you write are as much a part of this assignment as the linked list itself.

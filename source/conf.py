# -*- coding: utf-8 -*-
#
# Python 401 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'PythonDevAccelerator.tex', u'Python 401 Documentation',
   u'Cris Ewing', 'manual'),
]
...
man_pages = [
    ('index', 'pythondevaccelerator', u'Python 401 Documentation',
     [u'Cris Ewing'], 1)
]

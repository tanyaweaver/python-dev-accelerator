...
Work through the `first step <tutorials/learning_journal_1>`_ of the three part
Assignment to create a Python Learning Journal in the Pyramid (Links to an
external site.) web microframework.
